...
export const preDefinedCards: Array<Card> = [
  ...
  new Card('Серый король', [ManaColor.Blue, ManaColor.Violet, ManaColor.Brown], [[Tile.allColors, Tile.empty]], false),
  new Card('Королева призраков', [ManaColor.Green, ManaColor.Brown], [], false),
]
...
export const teams: Map<string, Array<string>> = new Map([
  ...
  ['🟫 Коричневый Серый Король', ['Крушитель', 'Серый король', 'Королева призраков', 'Дочь льда']],
